...
"# hotdealsguy"  git init git add README.md git commit -m "first commit" git remote add origin https://github.com/mrvamsidhar/hotdealsguy.git git push -u origin master
"# hotdealsguy" 
